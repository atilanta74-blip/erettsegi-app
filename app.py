...
# Detektív Játék (10-10 kérdésenként)
detektiv_irodalom = [
...
detektiv_nyelvtan = [
    ...
    {"idezet": "„egészségünkre / egésségünkre”", "helyes": "Helyesírás és kiejtés eltérése (Kiejtés elve)", "opciok": ["Helyesírás és kiejtés eltérése (Kiejtés elve)", "Hagyomány elve", "Szóelemzés elve", "Egyszerűsítés elve"], "info": "Kiejtés."}
]
...
if menupont == "📚 Tételek & Vázlatok":
    ...
    if st.button("Írásbeli küldés") and k:
        ...
        st.rerun()
        # -------------------------------------------------------------
# 3. TÖRTÉNELEM TÉTELTÁR (30 Részletesen Kidolgozott Tétel)
# -------------------------------------------------------------
tetelek_tortenelem = {
    "1. Az athéni demokrácia működése a Kr. e. V. században": {
        "alcim": "Szolón, Kleiszthenész reformjai, Periklész kora és a népgyűlés (ekklészia)",
        "kulcsszavak": ["Népgyűlés (Ekklészia)", "Cserépszavazás", "Sztratégosz", "Napidíj", "Periklész"],
        "audio_szoveg": "Az athéni demokrácia az ókori világ legfejlettebb népuralmi rendszere volt, amely Periklész idején érte el a virágkorát...",
        "vazlat": "### I. Előzmények: Szolón reformjai (vagyoni alapú jogok) és Kleiszthenész területi alapú reformjai (10 phülé).\n### II. Intézményrendszer: Népgyűlés (minden polgár részvésze), Bulé (Ötvenek tanácsa), Esküdtbíróság (heliaia), Sztratégoszok (katonai vezetők).\n### III. Periklész kora: A napidíjak bevezetése a szegények politikai részvételéért, cserépszavazás (ostrakismos) a türannisz ellen.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Bevezetés és kialakulás (Szolón, Kleiszthenész) -> 2. Főbb intézmények működése -> 3. Periklész korának reformjai és a cserépszavazás -> 4. Korlátok (nők, metoikuszok, rabszolgák kirekesztése).",
        "kviz": [{"k": "Az athéni népgyűlésen minden szabad athéni lakos részt vehetett.", "v": False, "m": "Csak a szabad athéni felnőtt férfi polgárok (a nők, idegenek és rabszolgák nem)."}]
    },
    "2. A Római Köztársaság válsága és a Principátus kialakulása": {
        "alcim": "A polgárháborúk kora, Caesar diktatúrája és Augustus principátusa",
        "kulcsszavak": ["Gracchusok", "Marius és Sulla", "Julius Caesar", "Augustus", "Pax Romana"],
        "audio_szoveg": "A Római Köztársaság a hódítások következtében mély társadalmi és gazdasági válságba került, ami polgárháborúkhoz vezetett...",
        "vazlat": "### I. A válság okai: A kisbirtokos parasztság tönkremenése, latifundiumok, rabszolgatartás, Gracchus testvérek reformkísérlete.\n### II. Polgárháborúk kora: Marius és Sulla ellentéte, Spartacus-féle rabszolgafelkelés, az első triumvirátus (Caesar, Pompeius, Crassus).\n### III. Caesar egyeduralma és Augustus: Caesar diktatúrája, meggyilkolása; Octavianus (Augustus) győzelme, a principátus bevezetése (Kr. e. 27), Pax Romana.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A köztársaság válságának okai -> 2. A polgárháborúk és Caesar útja -> 3. Augustus és a principátus rendszere -> 4. Pax Romana.",
        "kviz": [{"k": "Augustus a principátus bevezetésével teljesen eltörölte a köztársasági tisztségeket.", "v": False, "m": "Megtartotta a látszatot, ő maga princepsként (első polgárként) kormányzott."}]
    },
    "3. A kereszténység születése és elterjedése az ókorban": {
        "alcim": "Jézus tanításai, az őskeresztény gyülekezetek és a milánói ediktum (313)",
        "kulcsszavak": ["Názáreti Jézus", "Szent Pál", "Milánói ediktum (313)", "Nicaea", "Constantinus"],
        "audio_szoveg": "A kereszténység a Római Birodalom keleti tartományában, Palesztinában született meg a zsidó vallás talaján...",
        "vazlat": "### I. Történeti gyökerek: Názáreti Jézus élete, halála, feltámadásának hite; a szeretet, az alázat és a mennyei ország üzenete.\n### II. Terjedés: Szent Pál apostol munkássága, apostolok levelei, az őskeresztény gyülekezetek szolidaritása.\n### III. Fordulat: Üldözések (Nero, Diocletianus) után a Milánói ediktum (313 - Constantinus) szabad vallásgyakorlatot biztosít; 325-ös nicaea-i zsinat.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Jézus tanításai -> 2. Pál apostol és a kereszténység elterjedése -> 3. Üldözések és a Milánói ediktum -> 4. Constantinus szerepe.",
        "kviz": [{"k": "A Milánói ediktumot 313-ban adták ki, ami államvallássá tette a kereszténységet.", "v": False, "m": "Szabad vallásgyakorlatot biztosított (államvallássá csak később, I. Theodosius alatt vált)."}]
    },
    "4. A középkori uradalom és a hűbériség rendszere": {
        "alcim": "Hűbéri lánc (feudalizmus), a jobbágyság és a háromnyomásos gazdálkodás",
        "kulcsszavak": ["Senior és Vazallus", "Feudum", "Majorság és Jobbágytelek", "Háromnyomásos gazdálkodás"],
        "audio_szoveg": "A középkori Európa társadalmi és gazdasági rendszere a hűbériségen és az önellátó uradalmakon alapult...",
        "vazlat": "### I. Hűbériség (feudalizmus): Senior (földesúr) és vazallus (hűbéres) viszonya, hűségeskü, feudum (birtokadomány), hűbéri lánc.\n### II. Az uradalom: Majorság (a földesúr saját kezelésű földje) és jobbágytelkek (robot, terményadó, ajándék).\n### III. Gazdasági alapok: A nehézokos eke és a háromnyomásos gazdálkodás elterjedése (őszi vetés, tavaszi vetés, ugar).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A hűbériség fogalma és hierarchiája -> 2. Az uradalom felépítése és a jobbágyi kötelezettségek -> 3. Technikai újítások és a háromnyomásos gazdálkodás.",
        "kviz": [{"k": "A háromnyomásos gazdálkodásban a szántóföld egyharmada minden évben pihent (ugar volt).", "v": True, "m": "Így tudták megőrizni a talaj termékenységét műtrágya nélkül."}]
    },
    "5. Az Iszlám vallás születése és az arab-iszlám világ expanziója": {
        "alcim": "Mohamed próféta, a Korán, az iszlám öt oszlopa és a kalifátusok terjeszkedése",
        "kulcsszavak": ["Mohamed", "Hegidzsra (622)", "Korán", "Öt oszlop", "Kalifátus"],
        "audio_szoveg": "Az iszlám vallás a 7. század elején született meg az Arab-félszigeten Mohamed próféta közvetítésével...",
        "vazlat": "### I. Alapítás: Mohamed próféta fellépése Mekkában; a hegidzsra (622 - menekülés Medinabe, az iszlám időszámítás kezdete).\n### II. Tanítások: Egy isten (Allah), a Korán szent könyve, az iszlám öt oszlopa (hitvallás, ima, adakozás, böjt, zarándoklat).\n### III. Expanzió: Az arab törzsek egyesítése, gyors terjeszkedés a Közel-Keleten, Észak-Afrikában és Ibériában.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Mohamed és a 622-es hegidzsra -> 2. A Korán és az öt oszlop -> 3. Az arab hódítások és a kultúrközvetítő szerep.",
        "kviz": [{"k": "Az iszlám vallás időszámítása Mohamed születésétől veszi a kezdetét.", "v": False, "m": "A hegidzsra (Mekkából Medinába menekülés, 622) évétől számítják."}]
    },
    "6. Szent István államalapítása és az egyházszervezés": {
        "alcim": "A keresztény királyság megszilárdítása, vármegyerendszer és törvények",
        "kulcsszavak": ["Géza fejedelem", "Koronázás (1000/1001)", "10 püspökség", "Vármegyék", "Tized"],
        "audio_szoveg": "Szent István király törte meg a nemzetségfők hatalmát, és teremtette meg a keresztény magyar államot...",
        "vazlat": "### I. Előzmények: Géza fejedelem integrációs politikája, István házassága Gizellával, Koppány lázadásának legyőzése.\n### II. Egyházszervezés: 10 püspökség (Esztergomi érsekség), a tized (decima) bevezetése, kolostorok alapítása.\n### III. Államigazgatás: Vármegyerendszer (ispánok vezetése), udvarbirtokok, törvénykönyvek kibocsátása.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Géza és István hatalomra lépése -> 2. A koronázás jelentősége -> 3. Egyházszervezés és vármegyék -> 4. Törvények.",
        "kviz": [{"k": "Szent István tíz püspökséget hozott létre, amivel biztosította az ország egyházi függetlenségét.", "v": True, "m": "Esztergom központtal érsekséget alapított."}]
    },
    "7. Az Aranybulla és a rendi társadalom gyökerei (1222)": {
        "alcim": "II. András birtokpolitikája, a szerviensek mozgalma és a nemesi jogok rögzítése",
        "kulcsszavak": ["II. András", "Aranybulla (1222)", "Szerviensek", "Ellenállási záradék"],
        "audio_szoveg": "II. András elhibázott birtokpolitikája kikényszerítette az Aranybullát 1222-ben...",
        "vazlat": "### I. Előzmények: A királyi birtokok eladományozása ('új berendezkedés'), a királyi vármegyerendszer gyengülése.\n### II. A szerviensek (királyi katonák) fellépése: Védelem a bárókkal szemben.\n### III. Az Aranybulla (1222): Adómentesség, bírói eljárás garanciái, és a 31. cikkely (ellenállási záradék - ius resistendi).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. II. András politikája -> 2. Szerviensek helyzete -> 3. Az Aranybulla legfontosabb cikkelyei -> 4. Az ellenállási záradék.",
        "kviz": [{"k": "Az Aranybulla ellenállási záradéka megengedte a nemeseknek, hogy fegyverrel lépjenek fel a törvénytelen királyi döntések ellen.", "v": True, "m": "Ez volt a 31. cikkely."}]
    },
    "8. Az Anjouk kora Magyarországon": {
        "alcim": "Károly Róbert gazdasági reformjai és Nagy Lajos 1351-es törvényei",
        "kulcsszavak": ["Károly Róbert", "Urbura és Aranyforint", "Visegrádi találkozó (1335)", "Nagy Lajos és az Ősiség"],
        "audio_szoveg": "Károly Róbert legyőzte a tartományurakat, és stabil gazdasági alapot teremtett a királyság számára...",
        "vazlat": "### I. Károly Róbert konszolidációja: Oligarchák felszámolása, új gazdaságpolitika (bányabér vagyis urbura átengedése a földesuraknak, kapuadó, aranyforint).\n### II. Külpolitika: Visegrádi királytalálkozó (1335) a cseh és lengyel uralkodóval.\n### III. Nagy Lajos (1342–1382): Nápolyi hadjáratok, 1351-es törvények (ősiség, kilenced, egyenlő nemesi jogok).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Károly Róbert oligarcha-ellenes harcai -> 2. Gazdasági reformok -> 3. Nagy Lajos 1351-es reformjai (ősiség).",
        "kviz": [{"k": "Az 1351-es ősiség törvénye értelmében a nemesi birtok szabadon eladható volt bárkinek.", "v": False, "m": "Az ősiség lényege justement az volt, hogy a birtok elidegeníthetetlen volt a családon belül."}]
    },
    "9. Hunyadi Mátyás uralkodása (1458–1490)": {
        "alcim": "Központosított monarchia, bevételek, Fekete sereg és a reneszánsz udvar",
        "kulcsszavak": ["Hunyadi Mátyás", "Füstpénz", "Fekete sereg", "Corvinák", "Bécs bevétele"],
        "audio_szoveg": "Hunyadi Mátyás erős, központosított kora újkori államot hozott létre Magyarországon...",
        "vazlat": "### I. Hatalomra lépés (1458): A nemesség királlyá választja; a bárói ligák megfékezése.\n### II. Pénzügyi és katonai reformok: Kapuadó helyett füstpénz, rendkívüli hadiadó; az állandó zsoldoshadsereg (Fekete sereg) megszervezése.\n### III. Külpolitika és kultúra: Török elleni védelem (Jajca, Šabac), Csehország meghódítása, Bécs elfoglalása (1485); a reneszánsz kultúra és a Corvin-könyvtár meghonosítása.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Trónra lépés -> 2. Gazdasági és pénzügyi reformok -> 3. A Fekete sereg és a török politika -> 4. Humanizmus és reneszánsz udvar.",
        "kviz": [{"k": "Mátyás király eltörölte az adókat a jobbágyok körében, hogy népszerű legyen.", "v": False, "m": "Éppen ellenkezőleg: új adónemeket vezetett be (füstpénz, rendkívüli hadiadó), hogy fenntartsa a zsoldoshadsereget."}]
    },
    "10. A mohácsi csata és az ország három részre szakadása (1526–1541)": {
        "alcim": "A Jagelló-kor gyengesége, Mohács tragédiája, kettős királyválasztás és Buda eleste",
        "kulcsszavak": ["1526 Mohács", "Szapolyai János és I. Ferdinánd", "1541 Buda eleste", "Három rész"],
        "audio_szoveg": "1526. augusztus 29-én a mohácsi csatában a magyar seregek vereséget szenvedtek a törököktől...",
        "vazlat": "### I. Előzmények: A Jagelló-kor válsága, a királyi hatalom gyengülése, a déli végvárrendszer lepusztulása.\n### II. A mohácsi csata (1526): II. Lajos király halála, katonai katasztrófa.\n### III. Három részre szakadás: Kettős királyválasztás (Szapolyai János vs. Habsburg Ferdinánd); végül 1541-ben I. Szulejmán csellel elfoglalja Budát -> Királyi Magyarország, Hódoltság, Erdélyi Fejedelemség.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A Jagelló-kor belső válsága -> 2. Mohács (1526) eseményei és következményei -> 3. A kettős királyság -> 4. Buda 1541-es eleste és a három részre szakadás.",
        "kviz": [{"k": "Az ország három részre szakadása hivatalosan 1526-ban, a mohácsi csata napján megtörtént.", "v": False, "m": "1526 után még kettős királyság volt; a három részre szakadás 1541-ben (Buda eleste) következett be."}]
    },
    "11. A Rákóczi-szabadságharc (1703–1711)": {
        "alcim": "A Habsburg abszolutizmus elleni felkelés, az ónodi trónfosztás és a szatmári béke",
        "kulcsszavak": ["II. Rákóczi Ferenc", "Kurucok", "Ónod (1707)", "Szatmári béke (1711)"],
        "audio_szoveg": "II. Rákóczi Ferenc vezetésével a magyarság felszabadító harcot vívott a Habsburg uralom ellen...",
        "vazlat": "### I. Kikerülés a hatalomba: Brezáni kiáltvány (1703), a tiszántúli felkelők csatlakozása (események Esze Tamással).\n### II. A szabadságharc csúcspontja: Szécsényi országgyűlés (rendi konföderáció), az ónodi országgyűlés (1707 - Habsburg-ház trónfosztása, adóztatás a nemesekre).\n### III. Hanyatlás és lezárás: Katonai elszigetelődés, lojalitás hiánya a modern hadsereghez; Szatmári béke (1711) - amnesztia és rendi jogok biztosítása.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Kitörés és a bretáni kiáltvány -> 2. A kuruc sereg és a társadalmi bázis -> 3. Ónodi trónfosztás (1707) -> 4. A szatmári béke és kompromisszumai.",
        "kviz": [{"k": "Az ónodi országgyűlésen mondták ki a Habsburg-ház trónfosztását Magyarországon.", "v": True, "m": "1707-ben történt."}]
    },
    "12. A felvilágosult abszolutizmus Magyarországon": {
        "alcim": "Mária Terézia és II. József rendeletei (Védővám, Urbárium, Ratio Educationis, Türelmi rendelet)",
        "kulcsszavak": ["Mária Terézia", "Urbárium (1767)", "II. József (kalapos király)", "Türelmi rendelet (1781)"],
        "audio_szoveg": "A 18. század második felében a Habsburg uralkodók rendeletekkel próbálták modernizálni birodalmukat...",
        vazlat": "### I. Mária Terézia (1740–1780): Kettős vámrendelet (1754 - ipar Cseh/Ausztria, mezőgazdaság Magyarország), Urbárium (1767 - jobbágyterhek szabályozása), Ratio Educationis (oktatásügy).\n### II. II. József (1780–1790): A 'kalapos király', aki nem koronáztatta meg magát.\n### III. II. József főbb rendeletei: Türelmi rendelet (1781), Jobbágyrendelet (ne használják a jobbágy szót), nyelvrendelet (német hivatalos nyelvvé tétele).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A felvilágosult abszolutizmus lényege -> 2. Mária Terézia gazdasági és társadalmi reformjai -> 3. II. József rendeletpolitikája és ellenállása.",
        "kviz": [{"k": "II. József a magyar rendek örömére pompás koronázási ceremóniát tartott Budán.", "v": False, "m": "Meg sem koronáztatta magát, ezért hívták kalapos királynak."}]
    },
    "13. A reformkor fő kérdései (1830–1848)": {
        "alcim": "Széchenyi István és Kossuth Lajos reformprogramjának összehasonlítása",
        "kulcsszavak": ["Széchenyi István ('Hitel')", "Kossuth Lajos ('Pesti Hírlap')", "Örökváltság", "Közteherviselés"],
        "audio_szoveg": "A magyar reformkor az 1830-as évektől az 1848-as forradalomig tartó polgári átalakulási időszak volt...",
        "vazlat": "### I. Széchenyi István programja: 'Hitel' (1830), Világ, Stádium. A gazdasági modernizáció fontossága (hitel, ősiség eltörlése, közlekedés), felülről jövő építkezés, gróf Wesselényivel és a bárókkal való egyezkedés.\n### II. Kossuth Lajos programja: A Pesti Hírlap szerkesztése, politikai szabadságjogok, kötelező örökváltság állami kárpótlással, közteherviselés, népképviselet.\n### III. Eredmények: Balatoni hajózás, Lánchíd építése, vasutak, de a politikai áttörést csak 1848 hozta meg.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A reformkor kezdete és céljai -> 2. Széchenyi gazdaságközpontú programja -> 3. Kossuth politikai és társadalmi reformtervei -> 4. A két irányzat vitája.",
        "kviz": [{"k": "Széchenyi István azonnali, kötelező, államilag finanszírozott jobbágyfelszabadítást követelt.", "v": False, "m": "Széchenyi óvatosabb, önkéntes örökváltságot hirdetett, míg a kötelezőt Kossuth képviselte."}]
    },
    "14. Az 1848–49-es forradalom és szabadságharc": {
        "alcim": "Március 15., az Áprilisi törvények és a Tavaszi hadjárat sikerei",
        "kulcsszavak": ["12 pont", "Áprilisi törvények", "Batthyány-kormány", "Tavaszi hadjárat", "Világosi fegyverletétel (1849)"],
        "audio_szoveg": "1848 tavaszán európai forradalmi hullám söprt végig, amely Magyarországon átalakította az államrendszert...",
        "vazlat": "### I. Forradalom Pesten (1848. március 15.): Fiatal értelmiségiek (Petőfi, Vasvári), 12 pont, sajtószabadság, cenzúra eltörlése.\n### II. Áprilisi törvények: V. Ferdinánd szentesíti; felelős magyar kormány (Batthyány Lajos), jobbágyfelszabadítás, unió Erdélydel, népképviseleti országgyűlés.\n### III. Szabadságharc: Jellasics támadása, Pákozdi csata, Windisch-Grätz előrenyomulása, az 1849-es dicsőséges tavaszi hadjárat (Görgei Artúr); Függetlenségi nyilatkozat (ápr. 14 - trónfosztás); végül az orosz intervenció és világosi fegyverletétel.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. 1848. március 15. eseményei -> 2. Az Áprilisi törvények reformjai -> 3. A szabadságharc katonai fordulópontjai -> 4. Az orosz beavatkozás és a vereség.",
        "kviz": [{"k": "Az Áprilisi törvények megszüntették a jobbágyságot és rögzítették a felelős magyar kormányt.", "v": True, "m": "Ez volt a modern polgári Magyarország alapokmánya."}]
    },
    "15. A dualizmus kora Magyarországon (1867–1914)": {
        "alcim": "A Kiegyezés rendszere, gazdasági felvirágzás és társadalmi rétegződés",
        "kulcsszavak": ["Kiegyezés (1867)", "Deák Ferenc", "Közös ügyek", "Millennium (1896)", "Torlódó társadalom"],
        "audio_szoveg": "Az 1867-es kiegyezéssel létrejött az Osztrák-Magyar Monarchia, ami gazdasági fejlődést indított el...",
        "vazlat": "### I. A Kiegyezés (1867): Deák Ferenc munkája ('húsvéti cikk'); közös uralkodó (Ferenc József), közös ügyek (külügy, hadügy, pénzügy), gazdasági unió 10 évente megújítva.\n### II. Gazdasági csoda: Budapesti világvárosiasodás, vasúthálózat kiépítése, malomipar, mezőgazdasági export, Millennium (1896).\n### III. Társadalom: 'Torlódó társadalom' (régi dzsentri réteg mellett megjelenik a nagypolgárság és a modern munkásság).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A kiegyezés háttere és Deák Ferenc szerepe -> 2. Az államjogi konstrukció (közös ügyek) -> 3. Gazdasági modernizáció -> 4. Társadalmi sajátosságok.",
        "kviz": [{"k": "A dualista rendszerben Magyarországnak teljesen önálló külügyminisztériuma és hadserege volt.", "v": False, "m": "A külügy és a hadügy a 'közös ügyek' közé tartozott Bécs irányításával."}]
    },
    "16. Az első világháború és következményei (1914–1918)": {
        "alcim": "A szövetségi rendszerek, az állóháború jellege és a hátország összeomlása",
        "kulcsszavak": ["Szarajevói merénylet (1914)", "Központi hatalmak vs. Antant", "Állóháború", "Trianon (1920)"],
        "audio_szoveg": "Az első világháború kitörése véget vetett a békeidőszaknak, és átrendezte Európa térképét...",
        "vazlat": "### I. Okok és kirobbanás: Szarajevói merénylet (1914. június 28. - Ferenc Ferdinánd halála); kettős szövetségi rendszerek csatája.\n### II. Hadviselés: Villámháborús terv kudarca, lövészárkok, állóháború, új technológiák (gáz, tankok, repülő).\n### III. Következmények: A hátország éhezése, Osztrák-Magyar Monarchia szétesése, őszirózsás forradalom (1918), majd a Trianoni békediktátum (1920).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A világháború kitörésének okai -> 2. Az állóháború jellemzői -> 3. A Monarchia összeomlása -> 4. A trianoni következmények alapjai.",
        "kviz": [{"k": "Az első világháborúban az Amerikai Egyesült Államok az antant hatalmak oldalán lépett be 1917-ben.", "v": True, "m": "Ez jelentős fordulatot hozott."}]
    },
    "17. A Horthy-korszak konszolidációja (1920–1931)": {
        "alcim": "Trianon traumája, a bethleni konszolidáció és Klebelsberg kultúrpolitikája",
        "kulcsszavak": ["Horthy Miklós", "Bethlen István", "Pengő bevezetése (1927)", "Klebelsberg Kuno"],
        "audio_szoveg": "Trianon sokkja után a két világháború között Bethlen István konszolidálta Magyarországot...",
        "vazlat": "### I. Rendszerkiépülés: Horthy Miklós kormányzósága, ellenforradalmi rendszer, numerus clausus.\n### II. Bethleni konszolidáció (1921–1931): Politikai megállapodás a kormánypárton belül, népszövetségi kölcsön felvétele, a Pengő bevezetése (1927), a gazdaság talpra állítása.\n### III. Kultúrpolitika: Klebelsberg Kuno oktatási reformjai (népiskolák, egyetemi fejlesztések) a szellemi revízióért.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A trianoni sokk és a Horthy-korszak kezdete -> 2. Bethlen István konszolidációs lépései -> 3. Pénzügyi stabilizáció -> 4. Klebelsberg kultúrpolitikája.",
        "kviz": [{"k": "Bethlen István miniszterelnöksége alatt vezették be a stabil pengő fizetőeszközt 1927-ben.", "v": True, "m": "Ez váltotta fel a háborús inflációt szenvedő koronát."}]
    },
    "18. A második világháború főbb fordulópontjai (1939–1945)": {
        "alcim": "A náci agresszió, a szövetségesek koalíciója, Sztálingrád, D-nap és a holokauszt",
        "kulcsszavak": ["1939 Lengyelország", "Sztálingrádi csata", "D-nap (1944. június)", "Holokauszt / Soá"],
        "audio_szoveg": "A második világháború a történelem legpusztítóbb fegyveres konfliktusa volt...",
        "vazlat": "### I. A háború kitörése: Lengyelország német megtámadása (1939. srp. 1.), villámháborús sikerek Nyugat-Európában.\n### II. Fordulópontok: Hitler támadása a Szovjetunió ellen (Barbarossa-terv), a sztálingrádi csata (1942–1943 - szovjet győzelem), Normandiai partraszállás (D-nap: 1944. június 6.).\n### III. Emberi tragédia: A nácizmus fajelmélete és a holokauszt (milliós tömeggyilkosságok a táborokban).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Kitörés és a tengelyhatalmak előretörése -> 2. A keleti front fordulópontja (Sztálingrád) -> 3. A nyugati front nyitása (D-nap) -> 4. A holokauszt borzalmai.",
        "kviz": [{"k": "A sztálingrádi csata volt a második világháború csendes-óceáni hadszínterének fő fordulópontja.", "v": False, "m": "A keleti fronton (Európában) zajlott."}]
    },
    "19. Magyarország a második világháborúban (1941–1945)": {
        "alcim": "Revíziós sikerek, belépés a háborúba, a doni katasztrófa, a német megszállás és a nyilas terror",
        "kulcsszavak": ["Bécsi döntések", "Don-kanyar (1943)", "1944. március 19.", "Szálasi Ferenc és a nyilasok"],
        "audio_szoveg": "Magyarország a revíziós célok elérése érdekében sodródott bele a hitleri Németország oldalán a háborúba...",
        "vazlat": "### I. Revíziós sikerek és belépés: Bécsi döntések (Felvidék, Kárpátalja, Észak-Erdély visszatérése), belépés a Szovjetunió ellen (1941).\n### II. Katonai tragédia: A 2. magyar hadsereg megsemmisülése a Don-kanyarban (1943).\n### III. Megszállás és végjáték: Német megszállás (1944. március 19.), hazai zsidóság deportálása, Horthy októberi kiugrási kísérletének kudarca, nyilas terror.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A revízió ára és a hadbalépés -> 2. A Don-kanyari katasztrófa -> 3. Német megszállás és a holokauszt magyarországi fejezete -> 4. Nyilas uralom.",
        "kviz": [{"k": "A 2. magyar hadsereg 1943 elején szenvedett katasztrofális vereséget a Don-kanyarban.", "v": True, "m": "Tízezrek vesztették életüket."}]
    },
    "20. A hidegháború kialakulása és korszakai (1945–1991)": {
        "alcim": "Kétpólusú világ, fegyverkezési verseny, Truman-doktrína, kubai rakétaválság és szovjet összeomlás",
        "kulcsszavak": ["Vasfüggöny", "NATO és Varsói Szerződés", "Kubai rakétaválság (1962)", "Gorbacsov"],
        "audio_szoveg": "A második világháború után a győztes szuperhatalmak, az USA és a Szovjetunió szembenállása határozta meg a világot...",
        "vazlat": "### I. Kialakulás: Churchill jaltai beszéde, a 'vasfüggöny' leereszkedése Európában, Truman-doktrína (megfékezési politika).\n### II. Katonai tömbök és válságok: NATO (1949) és Varsói Szerződés (1955); Berlin blokádja, koreai háború, kubai rakétaválság (1962 - atomháború szélén).\n### III. Enyhülés és vég: Gorbacsov reformjai (glasznoszty, peresztrojka), a Szovjetunió felbomlása (1991).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A kétpólusú világ születése -> 2. Katonai szövetségek és fegyverkezési verseny -> 3. Válsághelyzetek -> 4. A hidegháború vége.",
        "kviz": [{"k": "Az 1962-es kubai rakétaválság idején az USA és a Szovjetunió a harmadik világháború küszöbén állt.", "v": True, "m": "Hatalmas atomfeszültség alakult ki."}]
    },
    "21. Az 1956-os magyar forradalom és szabadságharc": {
        "alcim": "A Rákosi-diktatúra válsága, október 23., Nagy Imre kormánya és a szovjet intervenció",
        "kulcsszavak": ["1956. október 23.", "Nagy Imre", "Semlegesség", "November 4. - Szovjet invázió"],
        "audio_szoveg": "1956 őszén a magyar társadalom fellázadt a Rákosi-féle sztálini diktatúra és a szovjet elnyomás ellen...",
        "vazlat": "### I. Előzmények: Sztálin halála, Hruscsov bírálata, írók köre, 1956. október 23-i békés egyetemi tüntetés.\n### II. Események: A Kossuth téri lövöldözés, a szovjet tankok bevonulása, Nagy Imre miniszterelnöki kormánya, a harcok abbahagyása.\n### III. Forradalom győzelme és bukása: Többpártrendszer bejelentése, Varsói Szerződésből való kilépés és semlegesség; végül november 4-én a szovjet 'Forgószél' hadművelet vérbe fojtotta a szabadságharcot.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A Rákosi-korszak válsága és október 23. -> 2. Nagy Imre fellépése és a követelések -> 3. A semlegesség kikiáltása -> 4. November 4-i szovjet invázió.",
        "kviz": [{"k": "Magyarország 1956 novemberében bejelentette kilépését a Varsói Szerződésből és semlegességét.", "v": True, "m": "Ez váltotta ki a szovjet fegyveres ellencsapást."}]
    },
    "22. A Kádár-rendszer korszaka és a „gulyáskommunizmus”": {
        "alcim": "Az 1956 utáni konszolidáció, a Kádár-féle politika és az életszínvonal-politika",
        "kulcsszavak": ["Kádár János", "Konszolidáció", "„Aki nincs ellenünk, az velünk van”", "Gulyáskommunizmus"],
        "audio_szoveg": "1956 után Kádár János nevéhez fűződik a Kádár-rendszer, amely a megegyezésen és a fogyasztói szocializmuson alapult...",
        "vazlat": "### I. Leszámolás és konszolidáció: Forradalmárok kivégzése (Nagy Imre), majd az amnesztia; a 'három T' kultúrpolitikája (Tűrt, Tiltott, Támogatott).\n### II. Új gazdasági mechanizmus (1968): Részleges piacgazdasági elemek bevezetése.\n### III. 'Gulyáskommunizmus': 'Aki nincs ellenünk, az velünk van' elv; viszonyslagos anyagi jólét és nyugalom a tömegek számára cserébe a politika passzivitásáért.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Az 1956 utáni retorzió és Kádár konszolidációja -> 2. A 'három T' kultúrpolitikája -> 3. Az életszínvonal-politika és a gulyáskommunizmus.",
        "kviz": [{"k": "A Kádár-rendszer kultúrpolitikáját a 'három T' elve határozta meg: Tiltott, Tűrt, Támogatott.", "v": True, "m": "Pontosan így osztályozták a műveket."}]
    },
    "23. A békés rendszerváltás Magyarországon (1989–1990)": {
        "alcim": "A Kádár-rendszer válsága, az Ellenzéki Kerekasztal, Nagy Imre újratemetése és a szabad választások",
        "kulcsszavak": ["Ellenzéki Kerekasztal (EKA)", "1989. június 16. (Újratemetés)", "1989. október 23.", "Szabad választások (1990)"],
        "audio_szoveg": "1989-1990-ben Magyarországon békés tárgyalások útján szűnt meg a kommunista egypártrendszer...",
        "vazlat": "### I. Válság és ellenzék: Gazdasági stagnálás, az MSZMP belső válsága, független szervezetek (MDF, SZDSZ, FIDESZ) megalakulása.\n### II. Az átmenet éve (1989): Ellenzéki Kerekasztal tárgyalások a hatalom átadásáról; Nagy Imre és mártírtársai újratemetése (június 16. - Orbán Viktor beszéde); határok megnyitása.\n### III. Köztársaság és választások: 1989. október 23-án kikiáltják a Magyar Köztársaságot; az első szabad parlamenti választások 1990 tavaszán (Antall József kormánya).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A Kádár-rendszer gazdasági és politikai válsága -> 2. Az Ellenzéki Kerekasztal és a békés átmenet -> 3. 1989 szimbolikus eseményei -> 4. Az 1990-es választások.",
        "kviz": [{"k": "Nagy Imre és mártírtársai újratemetése 1989 júniusában az ellenzéki összefogás és a rendszerbukás szimbólumává vált.", "v": True, "m": "Tízezrek vettek részt rajta."}]
    },
    "24. A nagy földrajzi felfedezések és a kapitalizmus hajnala": {
        "alcim": "A karavella, iránytű, Kolumbusz, Vasco da Gama és a globális kereskedelem",
        "kulcsszavak": ["Kolumbusz Kristóf (1492)", "Vasco da Gama", "Árforradalom", "Gyarmatosítás"],
        "audio_szoveg": "A 15. század végén az európaiak új kereskedelmi utakat kerestek India felé, ami átalakította a világgazdaságot...",
        "vazlat": "### I. Okok és feltételek: Török hódítások miatt drága a levantei kereskedelem; új hajózási technológiák (karavella, iránytű, asztrolábium).\n### II. Felfedezések: Spanyol és portugál expedíciók; Kolumbusz (1492 - Amerika elérése), Vasco da Gama (1498 - tengeri út India felé), Magellán (Föld körbehajózása).\n### III. Következmények: Új növények (kukorica, burgonya), árforradalom Európában, gyarmatosítás, rabszolga-kereskedelem, a kapitalizmus kibontakozása.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A felfedezések technikai és gazdasági okai -> 2. Főbb expedíciók (Kolumbusz, Gama) -> 3. Globális kereskedelem és az árforradalom.",
        "kviz": [{"k": "Kolumbusz Kristóf szándékosan Amerikát akarta felfedezni spanyol megbízásból 1492-ben.", "v": False, "m": "Indiába vezető nyugati tengeri utat keresett, és azt hitte, Ázsiába jutott."}]
    },
    "25. A reformáció és a katolikus megújulás (ellenreformáció)": {
        "alcim": "Luther Márton, Kálvin János, hitviták, új felekezetek és a barokk művészet",
        "kulcsszavak": ["Luther Márton (1517)", "Kálvin János", "Trentói zsinat", "Jezsuita rend", "Barokk"],
        "audio_szoveg": "A 16. században a katolikus egyház bírálatából kiindulva tömeges vallási megújulás, a reformáció indult el...",
        "vazlat": "### I. Lutheránus reformáció: Luther Márton 95 tétele (1517 - Wittenberg); egyedül a hit üdvözít, a Biblia a legfőbb tekintély, búcsúcédulák elutasítása.\n### II. Kálvini reformáció: Predestináció (eleve elrendelés), puritán egyházszervezet (presbiterek), ellenállási jog.\n### III. Katolikus megújulás (Ellenreformáció): Trentói zsinat (1545–1563 - fegyelem szigorítása), Loyolai Szent Ignác és a Jezsuita rend, a barokk művészet katolikus eszköze.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A reformáció kitörése és Luther tételcseréi -> 2. Kálvin János tanai -> 3. A katolikus ellenreformáció (Trentói zsinat és jezsuiták).",
        "kviz": [{"k": "Luther Márton 1517-ben tűzte ki 95 tételét, amivel elindította a reformációt.", "v": True, "m": "Wittenbergi templom kapujára szegezte."}]
    },
    "26. Az angol alkotmányos monarchia kialakulása a XVII. században": {
        "alcim": "A Stuart-házi absolutizmus kísérlete, polgárháború, Cromwell és az 1689-es Jognyilatkozat",
        "kulcsszavak": ["Angol polgárháború", "Oliver Cromwell", "Dicsőséges forradalom (1688)", "Jognyilatkozat (1689)"],
        "audio_szoveg": "A 17. századi Angliában a királyi önkény és a parlament küzdelméből született meg az első modern alkotmányos monarchia...",
        "vazlat": "### I. Előzmények: Stuart-házi királyok abszolutisztikus törekvései a parlament ellenében, puritán mozgalom.\n### II. Polgárháború és Köztársaság: Parlamenti seregek győzelme Oliver Cromwell vezetésével, I. Károly kivégzése (1649), katonai diktatúra.\n### III. Dicsőséges forradalom és Jognyilatkozat (1689): Orániai Vilmos hatalomra hívása vér nélkül; a Jognyilatkozat rögzíti a parlament jogait, a törvényhozás és végrehajtás szétválasztását.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Stuartok és a parlament konfliktusa -> 2. Polgárháború és Cromwell köztársasága -> 3. Dicsőséges forradalom -> 4. Az 1689-es Jognyilatkozat alapelvei.",
        "kviz": [{"k": "Az 1689-es angol Jognyilatkozat kimondta, hogy a király a parlament jóváhagyása nélkül nem hozhat törvényt.", "v": True, "m": "Ez az alkotmányos monarchia alapja."}]
    },
    "27. A francia polgári forradalom és Napóleon bukása": {
        "alcim": "A rendi gyűlés összehívása (1789), Emberi és Polgári Jogok Nyilatkozata, jakobinus diktatúra és Napóleon",
        "kulcsszavak": ["1789. július 14. (Bastille)", "Jogok Nyilatkozata", "Jakobinus terror", "Napóleon birodalma"],
        "audio_szoveg": "1789-ben Franciaországban kitört a forradalom, amely elsöpörte az Ancien Régime-et és átírta Európa történelmét...",
        "vazlat": "### I. A forradalom kitörése: XVI. Lajos összehívja a Rendi Gyűlést (1789), harmadik rend felkelése, Bastille ostroma (július 14.), Emberi és Polgári Jogok Nyilatkozata.\n### II. Radikalizálódás: Köztársaság kikiáltása, király kivégzése; a jakobinus diktatúra (Robespierre) és a tömeges terror időszaka.\n### III. Napóleon kora: 1799-es államcsíny, császárrá koronázás, polgári törvénykönyv (Code Napoléon), hódító háborúk, majd a katonai bukás (oroszországi hadjárat, Waterloo).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A francia forradalom okai és 1789 nyara -> 2. Az Emberi Jogok Nyilatkozata és a köztársaság -> 3. Jakobinus diktatúra -> 4. Napóleon uralma és bukása.",
        "kviz": [{"k": "A francia forradalom jelképes kezdete a Bastille börtönének ostroma volt 1789. július 14-én.", "v": True, "m": "Ez azóta is a francia nemzeti ünnep."}]
    },
    "28. Az ipari forradalmak hullámai és a munkáskérdés": {
        "alcim": "Gőzgép, gyári ipar, urbanizáció, vasútépítés és a szocialista eszmék születése",
        "kulcsszavak": ["James Watt gőzgépe", "Urbanizáció", "Munkáskérdés", "Marxizmus"],
        "audio_szoveg": "Az ipari forradalmak alapvetően változtatták meg az emberiség termelési módját és életmódját...",
        "vazlat": "### I. Első ipari forradalom (18. sz. vége - Anglia): Gőzgép (James Watt), textíliaipar, vasútépítés, nehézipar; falvakból városokba áramlás (urbanizáció).\n### II. Második ipari forradalom (19. sz. második fele): Elektromosság, belső égésű motor, vegyipar, tömegtermelés.\n### III. Társadalmi következmények: Tőkés burzsoázia és bérmunkás proletariátus; a munkáskérdés (szociális törvények hiánya, sztrájkok); szocialista eszmék (Marx és Engels).",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Az első ipari forradalom technikai újításai -> 2. Urbanizáció és a gyári munkásság helyzete -> 3. A második ipari forradalom -> 4. Munkásmozgalmak és a marxizmus.",
        "kviz": [{"k": "Az első ipari forradalom legfontosabb jelképe a gőzgép volt, amelyet James Watt tökéletesített.", "v": True, "m": "Felszabadította aipart a vízenergia korlátozásai alól."}]
    },
    "29. Az európai integráció és a globalizáció kezdetei": {
        "alcim": "A Schuman-terv, az EGK, az Európai Unió megalakulása (Maastrichti szerződés) és globalizáció",
        "kulcsszavak": ["Schuman-terv (1950)", "EGK (Római szerződés - 1957)", "Maastrichti szerződés (1992)", "Globalizáció"],
        "audio_szoveg": "A második világháború pusztítása után az európai államok az összefogás és az integráció útját választották...",
        "vazlat": "### I. Kezdetek: Robert Schuman francia külügyminiszter terve (1950) a szén- és acéltermelés közös irányításáról (ESZAK).\n### II. EGK és az EU: Római szerződés (1957 - Európai Gazdasági Közösség); Maastrichti szerződés (1992 - létrejön az Európai Unió, közös piac, egységes pénz, uniós polgárság).\n### III. Globalizáció: Világméretű gazdasági, kulturális és információs összefonódás az ezredfordulón.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. A háború utáni integráció szükségessége -> 2. Schuman-terv és az EGK -> 3. A Maastrichti szerződés és az EU -> 4. A globalizáció kihívásai.",
        "kviz": [{"k": "Az Európai Uniót hivatalosan az 1992-es Maastrichti szerződés hozta létre.", "v": True, "m": "Ekkor kapta az EU nevet és bővült ki a gazdasági együttműködés."}]
    },
    "30. A jelenkori világ globális kihívásai (klímaváltozás, migráció, információs társadalom)": {
        "alcim": "Környezeti válság, demográfiai folyamatok és a digitális kor kérdései",
        "kulcsszavak": ["Klímaváltozás", "Fenntartható fejlődés", "Migráció", "Információs társadalom"],
        "audio_szoveg": "A 21. század elején az emberiség példátlan méretű globális kihívásokkal néz szembe, amelyek megoldása nemzetközi összefogást igényel...",
        "vazlat": "### I. Környezeti válság: Globális felmelegedés, ökoszisztémák pusztulása, a fenntartható fejlődés elve.\n### II. Társadalmi-demográfiai folyamatok: Népességrobbanás a fejlődő országokban, elöregedés a fejlett államokban, gazdasági migráció és menekültválságok.\n### III. Információs társadalom: Internet, mesterséges intelligencia, digitális szakadék, fake news és az információ mint hatalom.",
        "szobeli": "**🎙️ 3 perces felelet:** 1. Ökológiai kihívások és klímaváltozás -> 2. Demográfiai trendek és migrációs hullámok -> 3. Az információs társadalom előnyei és veszélyei.",
        "kviz": [{"k": "A fenntartható fejlődés célja, hogy a jelenkor kielégítse szükségleteit a jövő generációinak kárára.", "v": False, "m": "Pont ellenkezőleg: a jövő generációinak veszélyeztetése nélkül kell biztosítani az erőforrásokat."}]
    }
}# -------------------------------------------------------------
# 2. MAGYAR NYELVTAN TÉTELTÁR (16 Részletesen Kidolgozott Tétel)
# -------------------------------------------------------------
tetelek_nyelvtan = {
    "1. A kommunikáció folyamata és tényezői": {
        "alcim": "A kommunikációs modell, nyelvi és nem nyelvi jelek, kommunikációs funkciók",
